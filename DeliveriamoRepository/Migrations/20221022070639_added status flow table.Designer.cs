...
namespace DeliveriamoRepository.Migrations
{
    ...
    [Migration("20221022070639_added status flow table")]
    partial class addedstatusflowtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveriamoRepository.Entity.StatusFlow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CanceledStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CanceledStatusId");

                    b.HasIndex("NextStatusId");

                    b.HasIndex("StatusId");

                    b.ToTable("StatusFlow");
                });
            ...
            modelBuilder.Entity("DeliveriamoRepository.Entity.StatusFlow", b =>
                {
                    b.HasOne("DeliveriamoRepository.Entity.Status", "CanceledStatus")
                        .WithMany()
                        .HasForeignKey("CanceledStatusId");

                    b.HasOne("DeliveriamoRepository.Entity.Status", "NextStatus")
                        .WithMany()
