...
namespace Deliveriamo.DTOs.Order
{
    ...
    {
        public OrderDto(int id, string paymentMethod, string orderDescription, decimal orderTotalAmount, DateTime? orderCreationDateTime, decimal deliveryTime, List<ProductDto> products)
        {
            Id = id;
